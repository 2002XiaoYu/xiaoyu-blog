...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220627134344443.png" alt="image-20220627134344443" style="zoom:50%;" />
...
2. 各项系数ai以及指数i(这里的ai的i是指a的下标)
   ...
   **方法1**：顺序存储结构直接表示
   ...
   <img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220627134953388.png" alt="image-20220627134953388" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220627140021075.png" alt="image-20220627140021075" style="zoom:50%;" />

多项式相加过程：从头开始，比较两个多项式当前对应项的的指数  =>这样就能够做到指数递降运算

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220627140719716.png" alt="image-20220627140719716" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220627141534773.png" alt="image-20220627141534773" style="zoom:50%;" />

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220627141555193.png" alt="image-20220627141555193" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220627191654197.png" alt="image-20220627191654197" style="zoom:50%;" />
...
3. <img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220627200204195.png" alt="image-20220627200204195" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220627234839331.png" alt="image-20220627234839331" style="zoom:50%;" />
...
3. 插入(在第i-1(1 <=  i <= n+1)个结点后插入一个值为X的新结点)
   ...
   <img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628002106165.png" alt="image-20220628002106165" style="zoom:50%;" />
   ...
   <img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628010648646.png" alt="image-20220628010648646" style="zoom:50%;" />

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628010948589.png" alt="image-20220628010948589" style="zoom:50%;" />

### 2.1.6 广义表与多重链表

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628012708073.png" alt="image-20220628012708073" style="zoom:50%;" />

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628012841252.png" alt="image-20220628012841252" style="zoom:50%;" />
...
7. ```c
   ...
   <img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628013451554.png" alt="image-20220628013451554" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628014523266.png" alt="image-20220628014523266" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628015146123.png" alt="image-20220628015146123" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628015420650.png" alt="image-20220628015420650" style="zoom:40%;" />
...
2. 头节点的标识值为"Head"，矩阵非0元素结点的标识值为"Term"
   ...
   <img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628015932693.png" alt="image-20220628015932693" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628024357415.png" alt="image-20220628024357415" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628032111469.png" alt="image-20220628032111469" style="zoom:50%;" />

**Push和Pop可以穿插交替进行**;

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628032222743.png" alt="image-20220628032222743" style="zoom:50%;" />

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628032242421.png" alt="image-20220628032242421" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628045906099.png" alt="image-20220628045906099" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628050006254.png" alt="image-20220628050006254" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628050745839.png" alt="image-20220628050745839" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628210030460.png" alt="image-20220628210030460" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220628215153143.png" alt="image-20220628215153143" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629041503372.png" alt="image-20220629041503372" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629052314628.png" alt="image-20220629052314628" style="zoom:50%;" />

```
采用不带头结点的单项链表，按照指数递减的顺序排列各项
```

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629052450477.png" alt="image-20220629052450477" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629060519985.png" alt="image-20220629060519985" style="zoom:50%;" />

演变过程------------------------分割线

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629060715728.png" alt="image-20220629060715728" style="zoom:50%;" />

接着是=>

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629060827486.png" alt="image-20220629060827486" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629070700010.png" alt="image-20220629070700010" style="zoom:50%;" />

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629070712967.png" alt="image-20220629070712967" style="zoom:50%;" />

## 小白专场

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629071856844.png" alt="image-20220629071856844" style="zoom:50%;" />

#### 多项式的表示

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629072141892.png" alt="image-20220629072141892" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629084605937.png" alt="image-20220629084605937" style="zoom:50%;" />

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629084915089.png" alt="image-20220629084915089" style="zoom:50%;" />

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629085051166.png" alt="image-20220629085051166" style="zoom:50%;" />

**处理方法2**

<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629085848083.png" alt="image-20220629085848083" style="zoom:50%;" />
...
<img src="../../public/中国大学慕课系列/数据结构(陈越)/image-20220629091612698.png" alt="image-20220629091612698" style="zoom:50%;" />
...
![image-20220629214627763](../../public/中国大学慕课系列/数据结构(陈越)/image-20220629214627763.png)
